...
class ProjectSearch extends Project
{
    ...
    {
        return [
            [['project_id', 'organization_id', 'responsibler_id', 'project_laksana_id', 'project_ep_id', 'project_kpi_id', 'projecti_paomai_id', 'project_plan_id', 'created_by', 'project_money', 'budget_budget_type', 'project_status', 'lastpage_id'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'project_consistency_id' => $this->project_consistency_id,
            'project_ep_id' => $this->project_ep_id,
        ...
        $query->andFilterWhere(['like', 'project_name', $this->project_name])
            ...
            ->andFilterWhere(['like', 'project_year', $this->project_year])
