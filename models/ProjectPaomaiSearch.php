...
class ProjectPaomaiSearch extends ProjectPaomai
{
    ...
    {
        return [
            [['paomai_id', 'paomai_type', 'paomai_owner'], 'integer'],
            [['paomai_value'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'paomai_type' => $this->paomai_type,
            'paomai_owner' => $this->paomai_owner,
        ]);

        $query->andFilterWhere(['like', 'paomai_value', $this->paomai_value]);
